...
{
  // Backlight: GPIO 23 (LCD_PWM) [3]
  gpio_set_direction(23, GPIO_MODE_OUTPUT);
  gpio_set_level(23, 1);

  // 1. Inizializzazione Bus MIPI DSI (2 lane @ 800Mbps) [4]
  ...
  // 2. Piano di controllo: DBI over DSI (API v5.5) [5]
  ...
  // 3. Timing Video DPI (Pixel Clock 51.2 MHz) [6]
  ...
  esp_lcd_dpi_panel_config_t dpi_config = {
      ...
      .dpi_clock_freq_mhz = 51200000, // API v5.5 [History]
  ...
  ESP_LOGI(TAG, "Display JD9165 pronto.");
}