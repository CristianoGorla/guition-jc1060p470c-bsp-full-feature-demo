...
/*
 * Local fallback defaults for slim BSP integration.
 * If the project defines these Kconfig symbols, those values still win.
 */
...
#ifndef CONFIG_CAMERA_OV02C10_ANA_GAIN_PRIORITY
...
#ifndef CONFIG_CAMERA_OV02C10_CSI_LINESYNC_ENABLE
#define CONFIG_CAMERA_OV02C10_CSI_LINESYNC_ENABLE 1
#endif

#ifndef CONFIG_CAMERA_OV02C10_ISP_AF_ENABLE
#define CONFIG_CAMERA_OV02C10_ISP_AF_ENABLE 0
#endif

#ifndef CONFIG_CAMERA_OV02C10_MIPI_IF_FORMAT_INDEX_DAFAULT
