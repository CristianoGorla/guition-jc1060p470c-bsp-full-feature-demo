 ...
 * ======================================================================== */
    ...
    #define DISP_DEBUG(tag, fmt, ...) \
        ESP_LOGI(tag, "\033[1;36m[SCAN] DISP\033[0m " fmt, ##__VA_ARGS__)
 ...
 * ======================================================================== */
    ...
    #define LVGL_DEBUG(fmt, ...) \
        ESP_LOGI("LVGL", "\033[1;35m[UI] LVGL\033[0m " fmt, ##__VA_ARGS__)
 ...
 * ======================================================================== */
    ...
    #define MEM_DEBUG(tag, fmt, ...) \
        ESP_LOGI(tag, "\033[1;33m[MEM] MEM\033[0m " fmt, ##__VA_ARGS__)
 ...
 * ======================================================================== */
    ...
    #define TIMING_END(tag, var, label) \
        do { \
            ...
            ESP_LOGD(tag, "  \033[0;36m[TIME] %s\033[0m: %llu us", label, elapsed); \
        } while(0)
#else
    #define TIMING_START(var)
    #define TIMING_END(tag, var, label)
